...
export default function HomeRoute({ params: lang }) {
            ...
            <section>
              ...
              <ul className="mt-2">
                {data.Histories.content?.map((item) => {
                  const find = Object.keys(item).find((obj) => obj !== "id");
                  return (
                    <li
                  ...
                  ({ id, title, describe, content, demo, code }, index) => (
                    <div className={`border-b-2 p-3`} key={id}>
                      ...
                      <div className="flex gap-3">
                        <Link href={demo} className=" text-100" target="_blank">
                          Demo
                        </Link>
                        <Link href={code} className=" text-100" target="_blank">
                          Code
                        </Link>
                      </div>
                    </div>
